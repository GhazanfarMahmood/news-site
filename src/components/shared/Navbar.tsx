        ...
        <header className="bg-bg py-3">
            <div className="container">
                <div className="flex justify-between items-center md:flex-nowrap flex-wrap flex-col sm:flex-row gap-[10px] sm:gap-0">
                    ...
                    <form className="flex items-center justify-center p-[2px_10px] border-[1px] border-dark bg-light rounded-[4px] has-focus:outline-dark has-focus:outline-[1px] order-none sm:max-md:order-3 md:mx-0 mx-auto mt-0 sm:max-md:mt-[10px]">
                        <input type="text" placeholder="Search..." aria-label="for search" className="text-[14px] placeholder:text-gray-500 text-dark focus:outline-none" />
