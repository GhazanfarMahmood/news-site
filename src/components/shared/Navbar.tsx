                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center justify-center gap-5">
                        <Link href={"/"} aria-label="favorite page link" className="flex items-center justify-center gap-1 text-dark transition-all delay-300 ease-in group hover:text-primary group">
                            <Image src={"/assets/images/icons/heart-regular.svg"} alt="heart-icon" width={20} height={20} className="w-5 object-contain  transition-all delay-300 ease-in group-hover:filter-(--filter-primary)" />
                            Favorite
                        </Link>
                        <button className="w-8 h-8 flex items-center justify-center border-[1px] border-dark rounded-md cursor-pointer transition-all delay-300 ease-in group hover:border-primary">
                            <Image src={"/assets/images/icons/moon.svg"} alt="moon-icon" width={20} height={20} className="w-5 object-contain transition-all delay-300 ease-in group-hover:filter-(--filter-primary)" />
